import { applyVoxelFlowingSurfaceGlint } from "./voxelFlowingSurfaceGlint.js";
...
export function applyStorybookSurfaceMaterial(material, {
  ...
  material = applyVoxelFlowingSurfaceGlint(material);
  ...
  material.onBeforeCompile = function onBeforeCompile(shader, renderer) {
    ...
    const kindSource = useSurfaceKindAttribute
      ? (material.userData?.voxelFlowingSurfaceGlint ? "" : "attribute float voxelSurfaceKind;")
