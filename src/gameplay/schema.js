...
export function normalizeTurnFacts(value = {}) {
  return {
    ...
    resourceBefore: value.resourceBefore ? normalizeGameplayResources(value.resourceBefore) : null,
    resourceAfter: value.resourceAfter ? normalizeGameplayResources(value.resourceAfter) : null,
    ...
    populationBefore: value.populationBefore ? normalizePopulationState(value.populationBefore) : null,
    populationAfter: value.populationAfter ? normalizePopulationState(value.populationAfter) : null,
