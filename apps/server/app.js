...
function owlReportHandoff(cityId, facts, config) {
  ...
  return {
    ...
    publish: {
      ...
      authoring_contract: {
        language: "zh-CN",
        language_rule: "Write masthead, edition, headline, subheadline, lead, article headlines/deks/bodies, briefs, action reasons, and tomorrow-watch text in natural Simplified Chinese.",
      ...
      body_template: {
        ...
        report: {
          ...
          edition: `第 ${facts.turn} 日版`,
          headline: "<根据上下文事实撰写简洁中文标题>",
          subheadline: "<可选中文副标题>",
          lead: "<根据上下文事实撰写生动中文导语>",
          articles: [],
          briefs: [],
          actionBox: [],
          tomorrowWatch: []
